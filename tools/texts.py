...
long_caption = ("⚠️ Учитывая длину описания и условий участия, превью розыгрыша не может быть "
                "создано!\n"
                "Проблема на стороне Telegram и его лимитов.\n\n"
                "Варианты решения проблемы:\n"
                "1. Уменьшите длину описания и условий участия\n"
                "2. Создайте розыгрыш без описания. Вы можете изменить текст розыгрыша "
                "после его публикации в Ваш канал/группу вручную.")
