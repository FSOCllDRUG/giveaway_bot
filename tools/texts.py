...
captcha_on_text = ("❗️<b>ВНИМАНИЕ.</b>\n"
                   ...
                   "Теперь каждый пользователь перед участием должен будет решить"
                   "графическую капчу. <b>При нажатии на кнопку участия, пользователь будет перебрасываться в Нашего "
                   "бота, где ему будет предложено ввести цифры,которые буду на картинке.</b>\n"
                   "После ввода правильных цифр пользователь станет участником розыгрыша.\n\n"
